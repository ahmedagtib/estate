                            ...
                            <div class="submit-section">
                                <div class="form-row">
                                    ...
                                    <div  class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" wire:model="meta_keyword"  value="{{$meta_keyword}}" placeholder="{{__('lang.example')}}{{__('lang.exmpletag')}}">
                                    </div>
