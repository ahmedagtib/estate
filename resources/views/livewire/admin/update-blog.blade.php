                 ...
                 <div class="dashboard-wraper">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <option value="blocked">{{__('lang.pending')}}</option>
                            <option value="approved">{{__('lang.published')}}</option>
                            </select>
                            <p class="text-danger">@error('statue') <span class="error">{{ $message }}</span> @enderror</p>
                        </div>
                        <div  class="form-group col-md-12">
                            <label>{{__('lang.tag')}}</label>
                            <input type="text" class="form-control" wire:model="tag"   placeholder="{{__('lang.example')}}{{__('lang.exmpletag')}}">
