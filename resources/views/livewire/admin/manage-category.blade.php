                            ...
                            <div class="submit-section">
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        <label>{{__('lang.entercategory')}}</label>
                                        <input type="hidden" wire:model="idcategory" value=""/>
                                        <input type="text" wire:model="category" class="form-control" placeholder="{{__('lang.entercategory')}}">
