        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <h2 class="ipt-title">{{__('lang.createadfree')}} - {{$city_id}}</h2>
                            ...
                            <div class="form-submit" >	
                                <div class="submit-section">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>{{__('lang.otherfeatures')}} {{__('lang.optional')}}</label>
                                            ...
                                            <div class="form-group col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div  class="col-md-3 text-center">
                                                        <div >
                                                            <img  class="rounded" width="100" height="100" src="{{ asset($oldphoto) }}">
                                                        </div>
                                                        <button class="mt-1 btn btn-danger btn-sm" wire:click="removePath({{'"'.$oldphoto.'"'}})"><i class="ti-trash"></i></button>
                                                    </div>
                                                    @endforeach
                                                </div>
                                            </div>
